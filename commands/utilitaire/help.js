...
- \`${client.config.prefix}welcome\`
                ...
                .setColor(color)
                .setTitle("Liste des commandes par permissions")
                .setDescription(`*Les commandes disponibles pour toutes les permissions sont aussi disponibles pour les personnes étant owner du bot*
...
- \`${client.config.prefix}wl [clear/list/add/remove <membre>]\` (*La whitlist ne donne aucune permissions sur le bot*)
            ...
            util.setDescription("*Les paramètres entre **`<...>`** sont obligatoire, alors que les paramètres entre **`[...]`** elles, sont facultatifs*")
            ...
            util.addField(`\`${prefix}calc <calcul>\``, "Permet de résoudre une équation mathématique via le bot")
